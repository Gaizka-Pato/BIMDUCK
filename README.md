...
- **Native IFC Exchange:** Seamless export and import. / **Intercambio IFC Nativo:** Exportación e importación fluida.
- **Auto-Layer Hierarchy:** Automatic translation of Rhino layers to IFC structures. / **Jerarquía de Capas Automática:** Traducción automática de capas a estructuras IFC.
- **Geometry Optimization:** Surgical refinement for lightweight, high-performance models. / **Optimización Geométrica:** Refinamiento quirúrgico para modelos ligeros y de alto rendimiento.
- **Massive Data Editing:** Professional parameter management and indexing. / **Edición Masiva de Datos:** Gestión profesional de parámetros e indexación.
...
- **[Download Latest: v0.0.18-beta+25275 (Beta)](https://github.com/Gaizka-Pato/BimDuck/releases/download/v0.0.18-beta+25275/BimDuck_v0.0.18-beta+25275.yak)**
...
- **[Descargar Última: v0.0.18-beta+25275 (Beta)](https://github.com/Gaizka-Pato/BimDuck/releases/download/v0.0.18-beta+25275/BimDuck_v0.0.18-beta+25275.yak)**
...
1. Download the `BimDuck_vX.X.X.zip` file. / Descarga el archivo `BimDuck_vX.X.X.zip`.
2. Extract the contents to your Rhino 8 scripts folder. / Extrae el contenido en tu carpeta de scripts de Rhino 8.
3. Use the integrated toolbar or run the scripts from the editor. / Usa la barra de herramientas integrada o ejecuta los scripts desde el editor.
